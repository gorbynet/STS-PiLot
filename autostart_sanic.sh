...
# uv4l --external-driver --device-name=video0 &
 ...
 uv4l --driver raspicam --auto-video_nr --encoding h264 --width 320 --height 240 --enable-server on --vflip --hflip --server-option --max-streams=10 --server-option --max-threads=12
